package com.lyh.app.statusbarTabs.StatusBarCompat.activity;
...
import com.lyh.app.statusbarTabs.StatusBarCompat.fragment.CollapsingToolbarFragment;
import com.lyh.app.statusbarTabs.StatusBarCompat.fragment.CommonFragment;
import com.lyh.app.statusbarTabs.StatusBarCompat.fragment.DrawerFragment;
import com.lyh.app.statusbarTabs.StatusBarCompat.fragment.TranslucentFragment;

import java.util.HashMap;

public class StatusBarCompatActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(null);
        setContentView(R.layout.activity_statusbar_compat);
        ...
        FragmentTransaction ft = StatusBarCompatActivity.this.getSupportFragmentManager().beginTransaction();
